...
class AcceptClaim extends Component{
    ...
    handleSubmit=(e)=>{
        ...
        // if(this.state.refund_amount_value-'0'<this.state.dispute_amount_value-'0'){
        //     var data = {
        //         dispute_id:this.state.dispute_id,
        //         body:{
        //         note:this.state.accept_claim_note,
        ...
        if((this.state.refund_amount_value<this.state.dispute_amount_value)&&(this.state.reason==="MERCHANDISE_OR_SERVICE_NOT_AS_DESCRIBED" )){
            console.log('aa');
        ...
        console.log(data);
        if(this.state.accept_claim_note && this.state.refund_amount_value>=0 && this.state.refund_amount_value<=this.state.dispute_amount_value){
            axios({
                url:'http://localhost:4000/accept_claim',
                method:'post',
                data:data
        })
            .then((res)=>{
            ...
            if(res.data.status===200){
                ...
                // console.log();
                alert('Something Went Wrong...'+res.data.details[0].issue);
            }
  ...
  render(){
    ...
    return(
            ...
            <div className=" action_div card row">
                ...
                {
                    (this.state.reason==="MERCHANDISE_OR_SERVICE_NOT_AS_DESCRIBED" &&this.state.refund_amount_value<this.state.dispute_amount_value)?(
