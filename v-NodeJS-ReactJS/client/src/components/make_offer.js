...
class MakeOffer extends Component{
    ...
    handleSubmit=(e)=>{
        console.log(this.state.mo_note);
        let data = {
        ...
        if(this.state.offer_type==="REFUND_WITH_RETURN"){
            console.log('aa');
            data.body.return_shipping_address={
                ...
                postal_code:this.state.mo_country_code
            }
        ...
        console.log(data);
        if(this.state.mo_note &&this.state.mo_offer_type&& this.state.mo_offer_amount_value>=0 && this.state.mo_offer_amount_value<=this.state.dispute_amount_value){
            axios({
                url:'http://localhost:4000/make_offer',
                method:'post',
                data:data
        })
            .then((res)=>{
            ...
            if(res.data.status===200){
                ...
                // console.log(res.data.details[0].issue);
            ...
            <div className=" action_div card row">
                ...
                <div className="col s12">
                    <select value={this.state.offer_type} id="mo_offer_type"className="browser-default" onChange={this.handleChange}>
                        ...
                        <option value="REPLACEMENT_WITHOUT_REFUND">Refund without replacement</option>
                        <option value="REFUND">Refund without any item </option>
